...
In diesem Kapitel haben wir eine Übersicht über die Architektur und die wichtigsten Highlights der Implementierung gekriegt. Wir wissen nun \textit{wie} der Lösungsansatz des Reranking-Algorithmus implementiert werden kann. Verknüpfen wir dieses Wissen mit dem aus Kapitel \ref{sec:Reranking}, haben wir eine gute Übersicht über den Lösungsansatz und dessen Implementierung in einer Suche. Mit dieser Implementierung der Suche wollen wir nun im nächsten Kapitel evaluieren, welche Verbesserung für das Qualitätsmaß der Suche von Springermedizin der Lösungsansatz bringt.